...
The catalogue in `index.md` is generated by `python scripts/rebuild_atlas.py`, and `python scripts/rebuild_atlas.py --check` reports drift, so do not hand-edit it. Archived pages are excluded automatically and remain available for history.

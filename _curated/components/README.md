...
## Purpose
Store governed `atlas.component` knowledge.
...
## Granularity rule
One page per meaningful repo, service, deployable unit, scheduled job group or reusable library. Do not split every handler/Lambda/script by default.

...
## Purpose
Store governed `atlas.standard` knowledge.
...
## Granularity rule
One page per reusable team engineering rule. Group by approved category; categories are organisational, not separate types.

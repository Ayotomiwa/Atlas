...
- Read `.agents/skills/_shared/human-intents.md` when routing Atlas work and `.agents/skills/_shared/persistence-approval.md` before any write-capable workflow.

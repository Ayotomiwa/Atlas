...
Write-capable specialist handoffs carry the exact persistence preview, approval, permitted file/claim/status effects, required contract reads and work-guard scope. A curator only returns materialized pages and its claim ledger; the parent owns checkpoint, validation, generation, repair, review and lifecycle. The specialist never expands scope or repeats approval; material changes return for a revised preview.

...
5. When coverage ends, disclose the boundary and inspect bounded product source. Offer setup once when relevant product instructions lack a managed Atlas block; never write from discovery.

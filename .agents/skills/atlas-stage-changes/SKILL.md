...
Read shared human-intent/persistence/runtime/provenance/handoff references, `_intake/README.md`, staging root/change policy and `references/workflow.md`. This is incremental **Sync Atlas**.

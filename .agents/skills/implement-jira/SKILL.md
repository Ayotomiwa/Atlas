...
1. Resolve the home Atlas package from the product repo's managed `AGENTS.md` block. When package discovery is needed, read `atlas-package.json`; otherwise route directly by stable ID, map, or index.

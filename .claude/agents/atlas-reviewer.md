...
6. Check sensitive-data handling, the materialized checkpoint, lint classification, repair-pass limit, scope-clean result and validation reporting. Respect an unrelated-baseline freshness deferral but require disclosure; current-cause failures and unexplained lint/compiler inconsistencies remain blocking.

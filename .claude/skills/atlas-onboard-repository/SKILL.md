...
Read `../_shared/human-intents.md`, `../_shared/persistence-approval.md`, `../_shared/runtime.md`, `../_shared/answer-provenance.md`, `../_shared/agent-handoffs.md`, `../_shared/curation-safety.md`, `references/full-baseline.md`, `references/clarification-checklist.md`, `_staging/README.md`, `_staging/index.md`, and all potentially relevant staging bucket contracts. This is the full-baseline **Sync Atlas** workflow and stages evidence only.

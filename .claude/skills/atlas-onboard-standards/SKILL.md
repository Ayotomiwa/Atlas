...
Read `../_shared/human-intents.md`, `../_shared/persistence-approval.md`, `../_shared/runtime.md`, `../_shared/answer-provenance.md`, `../_shared/agent-handoffs.md`, `../_shared/curation-safety.md`, `references/clarification-checklist.md`, the staging standards README/template/index, taxonomy and curated standards indexes. This is the standards route behind **Sync Atlas**.
...
5. When staging is justified, preserve the full source ledger, uncertainty and counterexamples. Show one concrete staging preview and obtain one approval; complete the shared taxonomy/contract and destination-contract reads before writing or handing off the unchanged evidence scope. Validate and create one exact-path local commit. Never create `must-follow` applicability from frequency alone or write curated standards.

...
5. When staging is justified, preserve the full source ledger, uncertainty and counterexamples. Show one concrete staging preview and obtain one approval; complete the shared taxonomy/contract and destination-contract reads before writing or handing off the unchanged evidence scope. Never create `must-follow` applicability from frequency alone or write curated standards.

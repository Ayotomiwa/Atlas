...
Read `../_shared/runtime.md`, `../_shared/answer-provenance.md`, `../_shared/agent-handoffs.md`, `references/clarification-checklist.md`, the staging standards README/template, taxonomy and curated standards indexes.

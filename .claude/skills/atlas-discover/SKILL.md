...
For a flow question, synthesize trigger and outcome; system boundaries; ordered participants and handoffs; data and infrastructure transitions; branches, retries, and failures; standards, incidents, and runbooks; and coverage limits from the existing model. Do not reduce the answer to a list of matched records.

...
Read `../_shared/human-intents.md`, `../_shared/runtime.md`, `../_shared/answer-provenance.md`, `../_shared/agent-handoffs.md`, and `../_shared/diagram-writing.md`. This is the risk-focused **Ask Atlas** route and is read-only.

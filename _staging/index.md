...
- [components](components/README.md) — Raw repository/component discovery grouped by evidenced domain or `unassigned`
- [flows](flows/README.md) — Raw end-to-end flow evidence grouped by evidenced domain or `unassigned`

...
- Repository identity, mutable locator, observed repository type, default branch, ownership evidence and scan boundary.
...
- Every plausible independently addressable component, its responsibility/boundary evidence, candidate parent and candidate domain.
